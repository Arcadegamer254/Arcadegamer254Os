        ...
        <div className="bg-white/5 rounded-xl p-3 mb-4 space-y-4">
          <div className="flex items-center space-x-3">
            <div className="w-6 flex justify-center">
              {audio?.muted ? <VolumeX className="w-4 h-4 text-gray-400" /> : <Volume2 className="w-4 h-4 text-gray-300" />}
            </div>
            <input 
              type="range" 
              min="0" 
              ...
              className="flex-1 h-1.5 bg-white/20 rounded-full appearance-none cursor-pointer accent-blue-400"
            />
          </div>
          <div className="flex items-center space-x-3">
            <div className="w-6 flex justify-center">
